...
/**
 * ClassName: ImageSevlet
 * PackageName: com.gw.servlet
 * Description:
 *
 * @Author: 谢金宸
 * @Create: 2023.5.17 下午 2:04
 * @Version: 1.0
 */
@WebServlet("/imgupload.action")
public class ImageSevlet extends HttpServlet {
    ...
    public String imgUpload(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        //图片上传路径
        String uploadPath = request.getServletContext().getRealPath("/images/uploadImg");
        System.out.println(request.getServletContext().getRealPath("/images/uploadImg"));
